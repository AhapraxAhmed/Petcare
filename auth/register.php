...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (!in_array($role, ['owner', 'vet', 'shelter'])) { // Roles from furshield.sql: admin, owner, vet, shelter
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="cursor-pointer">
                            <input type="radio" name="role" value="owner" class="sr-only peer" required>
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="role" value="vet" class="sr-only peer" required>
                            <div class="bg-white bg-opacity-20 border-2 border-white border-opacity-30 rounded-lg p-4 text-center peer-checked:border-white peer-checked:bg-opacity-30 transition-all">
    ...
    <script>
        ...
        function handleSocialLogin(provider) {
            ...
            if (!roleInput) {
                if (messageBox) messageBox.textContent = '⚠️ Please select a role before continuing.';
                return;
            }
            ...
            if (role === 'shelter') {
                ...
                if (!shelterName) {
                    if (messageBox) messageBox.textContent = '⚠️ Please enter your shelter name before continuing.';
                    return;
                }
            }
            ...
            fetch('save-role-session.php', {
                ...
                if (response.ok) {
                    ...
                    if (messageBox) messageBox.textContent = '⚠️ Error saving role. Please try again.';
                }
            });
        }
    </script>
