...
class NotificationService {
    ...
    public function sendVaccinationReminder($pet_id) {
        ...
        // $this->db->closeConnection(); // No need with singleton
    }
    ...
    public function sendAdoptionApplicationNotification($application_id) {
        ...
        $query = "SELECT aa.*, p.name as pet_name, u.name as applicant_name, u.email as applicant_email,
                  ...
                  JOIN users s ON al.shelter_id = s.id
                  WHERE aa.id = ?";
